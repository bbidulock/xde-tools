package XDE::Desktop2;
use base qw(XDE::Dual XDE::Actions);
use Linux::Inotify2;
use Glib qw(TRUE FALSE);
use Gnome2::VFS;
use XDE::Desktop::Icon2;
use XDE::Desktop::Icon::Shortcut2;
use XDE::Desktop::Icon::Directory2;
use XDE::Desktop::Icon::File2;
use strict;
use warnings;

=head1 NAME

XDE::Desktop2 -- XDE Desktop Environment (attempt 2)
...
=item $desktop = XDE::Desktop2->B<new>(I<%OVERRIDES>)

Creates an instance of an XDE::Desktop2 object.  The XDE::Desktop2
...
sub get_image {
	...
	$self->{images}{$id} =
	    XDE::Desktop::Image2->new($self,$names,$mime);
    }
...
sub create_objects {
	...
	$e = XDE::Desktop::Icon::Shortcut2->new($self,$l) unless $e;
	if ($e and $e->isa('XDE::Desktop::Icon::Shortcut2')) {
	    push @links, $e;
	    push @detop, $e;
	    $paths{$l} = $e;
	} else {
	...
	$e = XDE::Desktop::Icon::Directory2->new($self,$d) unless $e;
	if ($e) {
	    push @dires, $e;
	    push @detop, $e;
	    $paths{$d} = $e;
	...
	$e = XDE::Desktop::Icon::File2->new($self,$f) unless $e;
	if ($e) {
	    push @files, $e;
	    push @detop, $e;
	    $paths{$f} = $e;

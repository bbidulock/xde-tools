...
XDG::Menu::Tray::Mwm - generate a MWM system tray menu
...
B<XDG::Menu::Tray::Mwm> is a module that reads an
L<XDG::Menu::Layout(3pm)> tree and generates a Gtk2 menu for MWM.
...
=item $tray = XDG::Menu::Tray::Mwm->B<new>()

Creates a new XDG::Menu::Tray::Mwm instance for creating a  Gtk2::Menu.

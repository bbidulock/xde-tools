...
=item $wmh->B<event_handler_PropertyNotify_WIN_SUPPORTING_WM_CHECK>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_PROTOCOLS>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_WORKAREA>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_CLIENT_LIST>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_WORKSPACE_COUNT>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_WORKSPACE_NAMES>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_DESKTOP_BUTTON_PROXY>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_AREA_COUNT>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_ICONS>(I<$e>)
...
the C<$x>, C<$y>, origin and the C<$w> width and C<$h> height.  The
...
=item $wmh->B<event_handler_PropertyNotify_WIN_EXPANDED_SIZE>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_CLIENT_MOVING>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_LAYER>(I<$e>)
...
back again.  The "TrayPane" is on the IceWM panel where the system tray
is located.  The "TaskPane" is the task bar portion of the IceWM panel.
...
=item $wmh->B<event_handler_PropertyNotify_ICEWM_TRAY>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_STATE>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_HINTS>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_APP_STATE>(I<$e>)
...
=item $wmh->B<get_WIN_WORKSPACE>($window) =>  $workspace
...
=item $wmh->B<event_handler_PropertyNotify_WIN_WORKSPACE>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_WORKSPACES>(I<$e>)
...
=item $wmh->B<event_handler_PropertyNotify_WIN_AREA>(I<$e>)

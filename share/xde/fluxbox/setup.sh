...
name=fluxbox
files="version apps init keys overlay slitlist startup windowmenu"
xtras="fbdesk fbdesk.icons fbpager menuconfig usermenu"
clone="version"
udirs="backgrounds icons pixmaps styles"
menus="menu"
